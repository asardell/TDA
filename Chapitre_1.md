# Les bases de R et les vecteurs
...
- [Les bases de R et les vecteurs](#les-bases-de-r-et-les-vecteurs)
  - [Objectifs](#objectifs)
  - [Exercice 1 - Les objets et les vecteurs](#exercice-1---les-objets-et-les-vecteurs)
    - [Mémo](#mémo)
    - [Exercice sur les Fonctions en R](#exercice-sur-les-fonctions-en-r)
      - [Les fonctions `c()`,  `rm()`, `print()`](#les-fonctions-c--rm-print)
  - [Exercice 2 -  Fonctions usuelles](#exercice-2----fonctions-usuelles)
    - [Mémo](#mémo-1)
    - [Exercice sur les Fonctions en R](#exercice-sur-les-fonctions-en-r-1)
      - [Les fonctions `c()`,  `class()`](#les-fonctions-c--class)
      - [Les fonctions `c()`, `seq()`, `length()`](#les-fonctions-c-seq-length)
      - [Les fonctions `c()`, `rep()` (facultatif)](#les-fonctions-c-rep-facultatif)
      - [La fonction `rm()`](#la-fonction-rm)
  - [Exercice 3 -  Fonctions statistique univariées et simulation](#exercice-3----fonctions-statistique-univariées-et-simulation)
    - [Mémo](#mémo-2)
    - [Exercice sur les Fonctions en R](#exercice-sur-les-fonctions-en-r-2)
      - [Les fonctions `runif()`, `mean()`, `median()`, `min()`, `max()`](#les-fonctions-runif-mean-median-min-max)
      - [Les fonctions `rnorm()`, `mean()`, `sd()`,  `hist()`, `quantile()`](#les-fonctions-rnorm-mean-sd--hist-quantile)
      - [Les fonctions `sum()` , `round()`](#les-fonctions-sum--round)
      - [Les fonctions `sample()`, `table()`, `prop.table()` , `unique()`, `sort()`](#les-fonctions-sample-table-proptable--unique-sort)
...
| `sort()` | Trie les éléments d'un vecteur. | `x` : le vecteur ou la matrice à trier. `decreasing` : un booléen indiquant si le tri doit être effectué par ordre décroissant (par défaut, `FALSE`). | `vecteur_tri <- sort(vecteur)` |

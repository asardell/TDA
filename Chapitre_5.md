# Création et personnalisation de graphiques élémentaires
...
- [Création et personnalisation de graphiques élémentaires](#création-et-personnalisation-de-graphiques-élémentaires)
  - [Objectifs](#objectifs)
  - [Exercice 1 - Importer les données](#exercice-1---importer-les-données)
  - [Exercice 2 - L'histogramme](#exercice-2---lhistogramme)
    - [Mémo](#mémo)
      - [Type de trait](#type-de-trait)
    - [Exercice sur les Fonctions en R](#exercice-sur-les-fonctions-en-r)
      - [La fonction `hist()`](#la-fonction-hist)
      - [La fonction `abline()`](#la-fonction-abline)
      - [Les fonctions `hist()`, `lines()` et `density()`](#les-fonctions-hist-lines-et-density)
  - [Exercice 3 - Le boxplot](#exercice-3---le-boxplot)
    - [Mémo](#mémo-1)
      - [Type de points](#type-de-points)
    - [Exercice sur les Fonctions en R](#exercice-sur-les-fonctions-en-r-1)
      - [La fonction `boxplot()`](#la-fonction-boxplot)
      - [La fonction `par()`](#la-fonction-par)
      - [Les fonctions `points()` et `tapply()`.](#les-fonctions-points-et-tapply)
  - [Exercice 4 - Le diagramme](#exercice-4---le-diagramme)
    - [Mémo](#mémo-2)
    - [Exercice sur les Fonctions en R](#exercice-sur-les-fonctions-en-r-2)
      - [Les fonctions `barplot()` et  `table()`.](#les-fonctions-barplot-et--table)
      - [Les fonctions `barplot()` ,`prop.table()` et `legend()`.](#les-fonctions-barplot-proptable-et-legend)
      - [Les fonctions `pie()` et  `paste()`.](#les-fonctions-pie-et--paste)
      - [Les fonctions `palette()` et  `colors()`.](#les-fonctions-palette-et--colors)
      - [La fonction  `dev.print()`.](#la-fonction--devprint)
  - [Exercice 5 - Nuage de points](#exercice-5---nuage-de-points)
    - [Mémo](#mémo-3)
    - [Exercice sur les Fonctions en R](#exercice-sur-les-fonctions-en-r-3)
      - [La fonction `plot()`.](#la-fonction-plot)
      - [Les fonctions `plot()` et `levels()`.](#les-fonctions-plot-et-levels)
  - [Exercice 6 - Cartographie](#exercice-6---cartographie)
